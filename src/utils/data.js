...
export const WORK_EXPERIENCE = [
  ...
  {
    title: "Projeto - Sistema Para Petshop",
    date: "Abril 2023 - Junho 2023",
    responsibilities: [
  ...
  {
    title: "Estágio Polpa de Fruta Ideal",
    date: "Janeiro 2023 - Agosto 2023",
    responsibilities: [
      "Aplicação de conhecimentos adquiridos na graduação em Ciencia da Computação.",
      "Implementação de novas funcionalidades usando Inteligencia Artficial.",
